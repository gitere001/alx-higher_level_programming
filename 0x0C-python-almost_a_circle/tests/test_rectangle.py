...
Unittest classes:
    TestRectangleInstantiation - Test cases for testing the
    instantiation of the Rectangle class.
    TestRectangleWidth - Test cases for testing the initialization of the
    Rectangle width attribute.
    TestRectangleHeight - Test cases for testing the initialization of the
    Rectangle height attribute.
    TestRectangleX - Test cases for testing the initialization of the
    Rectangle x attribute.
    TestRectangleY - Test cases for testing the initialization of the
    Rectangle y attribute.
    TestRectangleOrderOfInitialization - Test cases for testing the order of
    attribute initialization.
    TestRectangleArea - Test cases for testing the area method of the
    Rectangle class.
    TestRectangleUpdateArgs - Test cases for testing the update_args method of
    the Rectangle class.
    TestRectangleUpdateKwargs - Test cases for testing the update_kwargs
    method of the Rectangle class.
    TestRectangleToString - Test cases for testing the __str__ method of the
    Rectangle class.
    TestRectangleDisplay - Test cases for testing the display method of the
    Rectangle class.
"""
import io
import unittest
